    ...
    <footer className="w-full bg-[#030712] relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-8">
          ...
          {/* 1. LOGO SECTION - ONLY LOGO IS BIG NOW */}
          <div className="flex flex-col gap-6">
            <div className="flex items-start group cursor-pointer w-fit relative">
              {/* Massive Logo Image */}
              <img 
                src={LogoImg} 
                alt="NowInfoTech Logo" 
                className="h-24 sm:h-32 lg:h-36 w-auto object-contain transition-transform duration-500 group-hover:scale-105" 
              />
              {/* Red Dot matched to Logo Size */}
              <span className="h-2.5 w-2.5 rounded-full bg-red-600 ml-2 mt-4 shadow-[0_0_15px_#ef4444] animate-pulse"></span>
            </div>
            ...
            {/* Social Icons - Normal Size */}
            <div className="flex items-center gap-5 mt-2">
              {[FaLinkedin, FaTwitter, FaInstagram, FaFacebookF].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-blue-400 hover:border-blue-500/50 transition-all duration-300">
          ...
          {/* 2. Services Links - Normal Professional Size */}
          ...
          {/* 3. Company Links - Normal Professional Size */}
          <div className="flex flex-col gap-6">
      ...
      <div className="w-full border-t border-white/[0.03] bg-black/40 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-gray-600 text-[11px] font-bold tracking-widest uppercase text-center">
            © 2026 <span className="text-white font-black tracking-tighter">NowInfoTech</span>. All rights reserved.
          </p>
